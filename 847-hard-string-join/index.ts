...
): <TParts extends string[]>(...parts: TParts) => Join<TParts, TDelimiter>;

type Join<TParts, TDelimiter extends string, TResult extends string = ""> = TParts extends [
  infer First extends string,
  ...infer Rest
] ? Join<Rest, TDelimiter, `${TResult}${First}${Rest extends never[] ? '' : TDelimiter}`>
: TResult
