...
type LengthOfString<S extends string, L extends unknown[] = []> = S extends `${infer First}${infer Rest}` ? LengthOfString<Rest, [...L, First]> : L['length']

type X = LengthOfString<'kumiko'>
