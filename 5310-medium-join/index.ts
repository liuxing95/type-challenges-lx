...
type Join<T extends any[], U extends string | number,R extends string = ''> = T extends [infer Head extends string | number, ...infer Tail ]
  ? Join<Tail, U, R extends '' ? Head : `${R}${U}${Head}`>
  : R
